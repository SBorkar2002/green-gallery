...
import './BalloonCac.css';
import snakeplant from '../Images/BalloonCactus.jpg';

const BalloonCac = () => {
    return (
        <div className='Baplant-care-page'>
            <h2>Balloon Cactus Plant Care Tips</h2>
            <div className='Baplant-care-container'>
                <img src={snakeplant} alt="Snake Plant" className='Baplant-image'/>
                <div className='Baplant-info'>
                    <ul>
            ...
            <NavLink to="/Cactus" className='Baback-link'>Back to Plant List</NavLink>
        </div>
    );
};

export default BalloonCac;
