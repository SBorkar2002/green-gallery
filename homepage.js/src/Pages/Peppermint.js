...
import snakeplant from '../Images/peppermint-plant.webp';

const Peppermint = () => {
    return (
        <div className='Pplant-care-page'>
            <h2>Peppermint Plant Care Tips</h2>
            <div className='Pplant-care-container'>
                <img src={snakeplant} alt="Snake Plant" className='Pplant-image'/>
            ...
            <NavLink to="/Medicinal" className='Pback-link'>Back to Plant List</NavLink>
        </div>
    );
};
