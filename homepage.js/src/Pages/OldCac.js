...
import './OldCac.css';
import snakeplant from '../Images/oldcac.webp';

const OldCac = () => {
    return (
        <div className='plant-care-page'>
            <h2>OldCacactus Plant Care Tips</h2>
            <div className='Ocplant-care-container'>
                <img src={snakeplant} alt="Snake Plant" className='Ocplant-image'/>
                <div className='Ocplant-info'>
                    <ul>
            ...
            <NavLink to="/Cactus" className='Ocback-link'>Back to Plant List</NavLink>
        </div>
    );
};

export default OldCac;
