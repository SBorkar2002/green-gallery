...
import './StatCac.css';
import snakeplant from '../Images/starcac.webp';

const StatCac = () => {
    return (
        <div className='Caplant-care-page'>
            <h2>Star Cactus Plant Care Tips</h2>
            <div className='Caplant-care-container'>
                <img src={snakeplant} alt="Snake Plant" className='Caplant-image'/>
                <div className='Caplant-info'>
                    <ul>
            ...
            <NavLink to="/Cactus" className='Caback-link'>Back to Plant List</NavLink>
        </div>
    );
};

export default StatCac;
