...
import './Jasmin.css';
import snakeplant from '../Images/jasmine.webp';

const Jasmin = () => {
    return (
        <div className='Jplant-care-page'>
            <h2>Jasmine Plant Care Tips</h2>
            <div className='Jplant-care-container'>
                <img src={snakeplant} alt="Snake Plant" className='plant-image'/>
                <div className='Jplant-info'>
                    <ul>
            ...
            <NavLink to="/Flowers" className='Jback-link'>Back to Plant List</NavLink>
        </div>
    );
};
